...
awful.util.spawn_with_shell("~/.scripts/newwall")
...
mytextclock = awful.widget.textclock('<span font="Inconsolata-dz 13" rise="2000"> <span font="Inconsolata-dz 8" color="#DDDDFF"> %a %d %b  %I:%M</span> </span>')
...
function (widget, args)
  ...
  if (args["{count}"] > 0) then
    ...
    return '<span background="#313131" font="Inconsolata-dz 13" rise="2000"> <span font="Inconsolata-dz 9">' .. args["{count}"] .. ' </span></span>'
  else
    notify_shown = false
    return ""
  end
...
function(widget, args)
	...
	if (args["{state}"] == "Play") then
		...
		if (args["{Artist}"] == "N/A") then
			return "<span background='#313131' font='Inconsolata-dz 13' rise='2000'> <span font='Inconsolata-dz 8'>" .. red .. args["{Title}"] .. coldef .. colwhi .. coldef .. colwhi  .. coldef .. " </span></span>"
		else
			return "<span background='#313131' font='Inconsolata-dz 13' rise='2000'> <span font='Inconsolata-dz 8'>" .. red .. args["{Title}"] .. coldef .. colwhi .. " - " .. coldef .. colwhi  .. args["{Artist}"] .. coldef .. " </span></span>"
		end
	-- pause
	elseif (args["{state}"] == "Pause") then
    mpdicon:set_image(beautiful.widget_music)
		return "<span background='#313131' font='Inconsolata-dz 13' rise='2000'> <span font='Inconsolata-dz 8'>" .. colwhi .. "paused" .. coldef .. " </span></span>"
	else
    mpdicon:set_image(beautiful.widget_music)
		return ""
	end
...
vicious.register(memwidget, vicious.widgets.mem, '<span font="Inconsolata 13" rise="2000"><span font="Inconsolata 8"> $2MB</span> </span>', 13)

-- CPU widget
cpuicon = wibox.widget.imagebox()
cpuicon:set_image(beautiful.widget_cpu)
cpuwidget = wibox.widget.textbox()
vicious.register(cpuwidget, vicious.widgets.cpu, '<span background="#313131" font="Inconsolata-dz 13" rise="2000"> <span font="Inconsolata-dz 8">$1% </span></span>', 3)
...
vicious.register(tempwidget, vicious.widgets.thermal, '<span background="#313131" font="Inconsolata-dz 12"> <span font="Inconsolata-dz 9">$1°C </span></span>', 9, {"coretemp.0", "core"} )

-- Pacman widget
pacicon = wibox.widget.imagebox()
pacicon:set_image(beautiful.widget_pac)
pacwidget = wibox.widget.textbox()
vicious.register(pacwidget, vicious.widgets.pkg, '<span background="#313131" font="Inconsolata-dz 13" rise="2000"> <span font="Inconsolata-dz 8">$1</span> </span>', 60, "Arch")
...
function add_info()
    ...
    infos = naughty.notify({
        text = string.format('<span font_desc="%s">%s</span>', "Inconsolata-dz", cal),
      	timeout = 0,
        position = "top_right",
        margin = 10,
        height = 170,
...
function (widget, args)
  ...
  if (batstate() == 'Cable plugged') then
    ...
    return '<span font="Inconsolata-dz 12"> <span font="Inconsolata-dz 9">AC </span></span>'
    -- critical
  elseif (args[2] <= 5 and batstate() == 'Discharging') then
    baticon:set_image(beautiful.widget_battery_empty)
    naughty.notify({
      text = "Close to shutdown...",
  ...
  elseif (args[2] <= 10 and batstate() == 'Discharging') then
    ...
    return '<span font="Inconsolata-dz 12" rise="2000"> <span font="Inconsolata-dz 8">' .. args[2] .. '% </span></span>'
end, 1, 'BAT0')
...
function (widget, args)
  ...
  return '<span font="Inconsolata-dz 13" rise="2000"> <span font="Iconsolata-dz 8">' .. args[1] .. '%</span> </span>'
end, 1, "Master")

-- Net widget
netwidget = wibox.widget.textbox()
vicious.register(netwidget, vicious.widgets.net, '<span background="#313131" font="Inconsolata-dz 13" rise="2000"> <span font="Inconsolata-dz 8" color="#7AC82E">${wlp2s0 down_kb}</span> <span font="Inconsolata-dz 7" color="#EEDDDD">↓↑</span> <span font="Inconsolata-dz 8" color="#46A8C3">${wlp2s0 up_kb} </span></span>', 3)
...
globalkeys = awful.util.table.join(
    ...
    awful.key({ }, "#123", function ()
                                       awful.util.spawn("amixer set Master playback 2%+", false )
